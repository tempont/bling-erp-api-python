...
from bling_erp_api.models.generated.invoices import NfceGetResponse200
...
def main() -> None:
    ...
    parsed = NfceGetResponse200(**result)  # type: ignore[reportArgumentType]
    print(parsed.model_dump_json(indent=2, by_alias=True))

    # NOTE: Uncomment and replace raw dict with NfcePostRequest(...) for typed payload construction.
